---
id: WINDOWS-COMMON-00-DETECT-WINDOWS
title: Windows erkennen
platform: windows
environment: native
area: windows/common
...
- Für echte Windows-Ersteinrichtung muss Codex in einer erhöhten Administrator-Sitzung laufen.
- Ohne Administratorrechte nur Erkennung, Baseline und Blockadebericht durchführen.
...
2. Administratorstatus erfassen und im Bericht dokumentieren.
3. Wenn Windows Features, Dienste, Firewall, Registry, Benutzer, Gruppen, systemweite Programme oder Richtlinien geändert werden sollen, Vollzugriff-Profil nach `Vorlage/common/10-admin-und-sudo-regeln.md` voraussetzen.
...
- Administratorstatus und Startprofil.
